...
\end{proofsketch}
\begin{proof}
  We formally define as $α(\init(\pe) \smallstep ...) \triangleq α_{\STraces}(\init(\pe) \smallstep ..., \StopF)$,
  ...
  The preservation results in are a consequence of \Cref{thm:abs-length,thm:need-adequate};

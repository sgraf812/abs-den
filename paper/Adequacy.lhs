...
one-to-one to the set of what we call the \emph{maximal} (\ie, longest possible)
small-step traces of the corresponding (lazy) Krivine machine.
We show adequacy in this manner at |D (ByNeed T)|.

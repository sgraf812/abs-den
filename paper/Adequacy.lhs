...
and we prove adequacy by showing the stronger and more interesting property that
the traces generated by |evalNeed2| \emph{bisimulate} traces of the Lazy Krivine
machine.
...
\begin{theoremrep}[Bisimulation]
  \label{thm:need-bisimulation}

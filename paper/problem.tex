...
This definition captures diverging behaviors correctly and is somewhat
easy to grasp despite its description as a property relating two traces.
Unfortunately, it is not a property preserved under evaluation:
, it is quite a narrow property. Knowing that $x$ is dead in $\pe$ does not give us

...
\begin{definition}[Evaluation cardinality]
  \label{defn:deadness2}
...
In other words, evaluation cardinality is an upper bound on the number of
$\LookupT$ transitions that alias to a variable.

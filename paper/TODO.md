...
* [x] Decide whether to keep the by-name analogue of the abstract-interpretation
  theorem. Kept and stated: thm:abstract-by-name is now Theorem in the §5.1 body
  (statement lifted out of the stripped appendix into Soundness.lhs), proof stays
  in sec:by-name-soundness. All four references resolve. Removable later if wanted.

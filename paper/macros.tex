...
% slantbox from https://tex.stackexchange.com/a/63188/52414
\newsavebox{\foobox}
...
% Comments and notes
\providetoggle{hidetodos}
\settoggle{hidetodos}{false}
\newcommand{\slpj}[1]{\nottoggle{hidetodos}{\textcolor{blue}{\emph{SLPJ: #1}}}}
\newenvironment{slpjenv}{\em SLPJ:}{}
\newcommand{\sg}[1]{\nottoggle{hidetodos}{\textcolor{blue}{\emph{SG: #1}}}}
\newcommand{\sven}[1]{\nottoggle{hidetodos}{\textcolor{blue}{\emph{Sven: #1}}}}
\newcommand{\todo}[1]{\nottoggle{hidetodos}{\textcolor{red}{TODO: #1}}}

% Lean code listings
\lstdefinelanguage{Lean}{
  morekeywords={def,fun,match,with,if,then,else,let,in,structure,class,instance,inductive,abbrev,do,by,where},
  sensitive=true,
  morecomment=[l]{--},
  morecomment=[s]{/-}{-/},
  morestring=[b]",
...
\lstset{
  ...
  breakindent=2em,
  literate=
    {→}{{$\to$}}1 {↦}{{$\mapsto$}}1 {ρ}{{$\rho$}}1 {μ}{{$\mu$}}1 {⊑}{{$\sqsubseteq$}}1
    {₀}{{$_0$}}1 {₁}{{$_1$}}1 {₂}{{$_2$}}1 {ₛ}{{$_s$}}1
    {«}{{\guillemotleft}}1 {»}{{\guillemotright}}1,
}

% Logical-relation tower diagram
\tikzset{lrbox/.style={draw, rounded corners, align=center, inner sep=4pt, font=\small}}
...
% https://gist.github.com/lambdageek/075ea17f362bc455467a
\makeatletter
\def\arcr{\@arraycr}
\makeatother
...
\newcommand{\argcons}{\mathbin{\bbcolon}}

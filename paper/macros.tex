...
\newcommand{\Letn}[3]{\mathbf{let}_n~{#1}\nobreak=\nobreak{#2}~\mathbf{in}~{#3}}
...
\newcommand{\semevt}[1]{\mathcal{S}^{ε}\denot{#1}}
\newcommand{\semst}[1]{\mathcal{S}^{σ}\denot{#1}}
\newcommand{\sembare}[1]{\mathcal{S}^{\bullet}\denot{#1}}

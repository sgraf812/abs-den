...
\newcommand{\UsgD}{\Domain{\exists ω}}
...
\newcommand{\semscott}[1]{\mathcal{S}\denot{#1}}
...
\newcommand{\semusg}[1]{\mathcal{S}^{∃ω}\denot{#1}}
...
\newcommand{\maxtrace}[1]{#1\;\mathsf{max\text{-}}π}
\newcommand{\maxtracen}[2]{#2\;\mathsf{max\text{-}}π^{#1}}
\newcommand{\elabstate}[1]{#1\;\mathsf{elab\text{-}}σ}
\newcommand{\elabtrace}[1]{#1\;\mathsf{elab\text{-}}π}
\newcommand{\elabtracen}[2]{#2\;\mathsf{elab\text{-}}π^{#1}}

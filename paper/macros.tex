...
\newcommand{\stuckend}[1]{\someend{#1}_{\lightning}}
\newcommand{\makestuck}[1]{\lightning(#1)}
\newcommand{\cons}{\mathbin{::}}
\newcommand{\lcons}{\mathbin{:\vartriangleright}}
...
\newcommand{\BareD}{\Domain{\bullet}}
\newcommand{\BareV}{\Values{\bullet}}
\newcommand{\UsgD}{\Domain{\exists u}}
\newcommand{\LookD}{\Domain{\nelems{\LookupA}}}
\newcommand{\LookTraces}{{\mathbb{T}^{\nelems{\LookupA}}}}
\newcommand{\LookValues}{\Values{\nelems{\LookupA}}}
...
\newcommand{\sembare}[1]{\mathcal{S}_{\bullet}\denot{#1}}
\newcommand{\semss}[1]{\mathcal{S}_{Σ}\denot{#1}}
\newcommand{\semlive}[1]{\mathcal{S}_{∃l}\denot{#1}}
\newcommand{\semusg}[1]{\mathcal{S}_{∃u}\denot{#1}}
\newcommand{\semclive}[1]{\mathcal{S}_{cl}\denot{#1}}
\newcommand{\semslive}[1]{\mathcal{S}_{sl}\denot{#1}}
\newcommand{\semsclive}[1]{\mathcal{S}_{scl}\denot{#1}}
\newcommand{\semty}[1]{\mathcal{S}_{τ}\denot{#1}}

% Stateful
\newcommand{\States}{\mathbb{S}}
\newcommand{\STraces}{{\mathbb{S}^{\infty}}}
\newcommand{\BTraces}{{\mathbb{T}^{\bullet}}}
\newcommand{\tSTraces}{\tilde{\mathbb{S}}^{\infty}}
\newcommand{\LKStates}{\mathbb{L}}
\newcommand{\LKTraces}{\mathbb{L}^{\infty}}

...
\newcommand{\STransitions}{\mathsf{STrans}}
\newcommand{\strans}[1]{\xhookrightarrow{#1}}
\newcommand{\sstep}{;}
\newcommand{\sconcat}{\concatop{\hspace{0.1ex}\scalebox{0.5}{\Sigma}}}
...
\newcommand{\funnyComp}{\mathop{\texttt{>=>}}}
\newcommand{\validtrans}[1]{#1\;\mathsf{ok\text{-}}t}
\newcommand{\validtrace}[1]{#1\;\mathsf{ok\text{-}}σ}

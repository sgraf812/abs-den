...
\pgfkeys{tikz/mymatrix/.style={matrix of math nodes,nodes in empty cells,inner sep=1pt,outer sep=1.5pt,column sep=2pt,row sep=2pt,nodes={minimum width=20pt,minimum height=10pt,anchor=west,inner sep=0pt,outer sep=0pt}}}

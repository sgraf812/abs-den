...
Now we have two challenging alternatives:
\begin{enumerate}
\item Develop a soundness proof that links a
  ...
  traces over abstract machine configurations with the compositional structure
  of the analysis.
...
abstract interpretation theorem and the shared definition helps to decompose the proof.

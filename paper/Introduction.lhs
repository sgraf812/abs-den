...
\item A concrete instantiation of a denotational interpreter is \emph{total}
  ...
  \Cref{sec:totality} proves that the by-need instantiation is total by defining
  the generic interpreter with guarded recursion.
\item \Cref{sec:adequacy} proves that the traces generated by the by-need
  ...
  lazy Krivine (LK) machine~\citep{Sestoft:97}.

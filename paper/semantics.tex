...
Note that we will continue to use the notation $τ \cons τ'$ quite liberally to
denote concatenation of traces. Doing so is unambiguous (because states are
...
Intuitively, the heap lists the denotation of the expression at a particular
address, while the environment passed to $\semst{\wild}$ assigns each

...
\[
  OK(d,σ) \triangleq src_\States(d(σ)) = σ \wedge \maxtrace{d(σ)} \wedge \elabtrace{d(σ)}
\]
...
$OK(d_2,σ_1)$.
If $π_1 = σ_1; π_1'$ then $\elabstate{σ_1}$ and $σ_1 \smallstep
src_\States(π_1')$ by the assumption $OK(d_1,σ_1)$.

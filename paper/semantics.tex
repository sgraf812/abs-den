...
\sg{This section is a bit in limbo and might resolve into the next chapter about
stateless trace semantics and Related Work later on. Simon might find the first
part here interesting}
...
\sg{Why not omit labelled expressions, then? CFA, of course, but then the
preceding sentence seems like a bit of a red herring}

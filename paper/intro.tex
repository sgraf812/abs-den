...
\begin{itemize}
  ...
  \item In \Cref{sec:semantics}, we give a compositional semantics
    ...
    semantics, our semantics is defined by \emph{guarded recursion}~\citep{Mogelberg:14}
    and thus total as a mathematical function.
    ...
    qualities and prove it correct \wrt a standard operational semantics.
  \item The semantics in \Cref{sec:semantics} is one generating \emph{stateful}
    ...
    convenient bridge for proving bisimulation \sg{No longer}.

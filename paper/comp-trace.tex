...
\begin{abstract}
  ...
  as much operational detail as we please, and that the structural definition
  ...
  We demonstrate the usefulness of our trace semantics by proving correct
  a static analysis for estimating the number of variable lookups by abstract
  interpretation.
\end{abstract}

...
\[\begin{array}{c}
 ...
 \begin{array}{rcl}
  ...
  \select(d,\alts) & = & d \betastep \fn{(\ConV(K_s,\many{d_s^\later}))}{\alts(K_s, \many{d_s^\later})} \\
 ...
 \begin{array}{rcl}
  ...
  \semless{\Case{\pe_s}{\Sel[r]}}_ρ & = &
    \begin{letarray}
      \text{let} & \alts = \fn{K}{\fn{\many{d^\later}}{\CaseEA(K,\many{\px↦d^\later}) \fcons \semless{\pe_r}_{ρ[\many{\px↦d^\later}]}}} \\

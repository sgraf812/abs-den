...
\begin{definition}[Lazy elements]
  ...
  \begin{enumerate}
    \item \textup{(Forces)} For all $μ,μ' ∈ \Heaps$ such that $d(μ) = ... \cons \goodend{\wild,μ'}$, it is the case that $μ \forcesto μ'$.
    \item \textup{(Postpone)} For all $μ_1,μ_2 ∈ \Heaps$ such that $μ_1 \forcesto μ_2$ and
    ...
    \item \textup{(Speculate)} For all $μ_1,μ_2 ∈ \Heaps$ such that $μ_1 \forcesto μ_2$ and

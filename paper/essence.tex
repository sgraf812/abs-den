...
\begin{proof}
  ...
  % Have m(μ2) < m(μ3) From μ2(a) /= μ3(a), μ2→μ3
  % Have μ2→μ2' From μ2(a) Forces
  % Have m(μ2) <= m(μ2') <= m(μ3) From μ2→μ2', μ2'→μ3
  % Have <μ1(a),μ2>⇓<v,μ2'> From μ1(a)=μ2(a) and <μ2(a),μ2>⇓<v,μ2'>
  % Have <μ1(a),μ1>⇓<v,μ1'>, μ1'→μ2' From μ1(a) Speculate, <μ1(a),μ2>⇓<v,μ2'>
  % Have μ1→μ1' From μ1(a) Forces
  % Have m(μ1) <= m(μ1') <= m(μ2') From μ1→μ1', μ1'→μ2'
  ...
  Again, by induction on the derivation on $μ_1 \forcesto μ_2$ we may assume
...
\begin{lemma}
  ...
  Then for all $\pa ∈ \dom(μ_1)$, we have $\dom(μ_1) ⊦ μ_1(\pa)(μ_1) \sim μ_2(\pa)(μ_2)$.
\end{lemma}
\begin{proof}
  ...
  then both judgments hold by the Forces property and $μ_1' \forcesto μ_2'$, so it
  suffices to show ${\dom(μ_1) ⊦ \goodend{v,μ_1'} \sim \goodend{v,μ_2'}}$.

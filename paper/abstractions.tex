...
\begin{definition}[Denotational deadness, lazily and wrong]
...
Even when $μ(\pa)$ is never forced, the entry will be listed in the final heap
of a trace ending in $\goodend{}$.

It is reasonable to define an observation function

...
We write $d_1 \impequiv d_2$ when $d_1 \faster d_2$ and $d_2 \faster d_1$, in
...
%      at $μ_1$.
      ...
      If either $\bigstep{d}{μ_1}{v}{μ_1'}$ or $\bigstep{d}{μ_2}{v}{μ_2'}$
      ...
      \forcesto μ_2'$. Hence it suffices to show

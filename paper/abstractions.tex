...
The \emph{usage abstraction} $\usg_\Traces : \Traces \to \LookTraces$
...
\begin{theoremrep}[$\semusg{\wild}$ approximates usage abstraction]
...
all, encoding the inductive hypothesis of the proof above in a chain of Galois
connections. Then the above proof is simply by \emph{cases} on $\pe$ and
equational reasoning, rather than by induction

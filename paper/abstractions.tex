...
%      at $μ_1$.
      ...
      We do so by applying rule $\impval$, postponing the $\lessdot$ goal and focusing
      on the $\impheap$ goal first.
      ...
      We can relax the address space to $\dom(μ_1) ∪ \{ \pa \}$ by \Cref{thm:weaken-address-space-imp},
